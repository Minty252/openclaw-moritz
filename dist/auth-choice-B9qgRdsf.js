import { _ as resolveConfigDir, l as escapeRegExp } from "./utils-Bu8JlY-C.js";
import { a as resolveAgentModelPrimary, c as resolveDefaultAgentId, r as resolveAgentDir, s as resolveAgentWorkspaceDir, w as resolveDefaultAgentWorkspaceDir } from "./agent-scope-dwzDG1b1.js";
import { B as getCustomProviderApiKey, Ct as ensureAuthProfileStore, D as VENICE_DEFAULT_MODEL_REF, It as DEFAULT_MODEL, Lt as DEFAULT_PROVIDER, Ot as resolveOpenClawAgentDir, P as SYNTHETIC_DEFAULT_MODEL_REF, St as upsertAuthProfileWithLock, W as resolveEnvApiKey, d as resolveConfiguredModelRef, gt as parseOAuthCallbackInput, ht as generateChutesPkce, mt as exchangeChutesCodeForTokens, nt as isHuggingfacePolicyLocked, pt as CHUTES_AUTHORIZE_ENDPOINT, rt as CLOUDFLARE_AI_GATEWAY_DEFAULT_MODEL_REF, st as resolveAuthProfileOrder, tt as discoverHuggingfaceModels, u as resolveAllowlistModelKey, vt as listProfilesForProvider, xt as upsertAuthProfile } from "./model-selection-ChgnVmWu.js";
import { s as loadModelCatalog } from "./runner-STmMAoZV.js";
import { r as isLoopbackHost } from "./ws-DDh2NOiX.js";
import { a as fetchWithTimeout } from "./fetch-CM9eyp_0.js";
import { d as openUrl } from "./onboard-helpers-DsWG_ruh.js";
import { a as enablePluginInConfig } from "./onboard-channels-DqtbGncN.js";
import { $ as applyCloudflareAiGatewayProviderConfig, A as applyMoonshotConfig, At as QIANFAN_DEFAULT_MODEL_REF, B as applyTogetherConfig, C as applyMinimaxConfig, Ct as setVercelAiGatewayApiKey, D as applyHuggingfaceProviderConfig, Dt as writeOAuthCredentials, Et as setZaiApiKey, F as applyOpenrouterProviderConfig, Ft as ZAI_GLOBAL_BASE_URL, G as applyXaiProviderConfig, H as applyVeniceConfig, I as applyQianfanConfig, It as buildTokenProfileId, J as applyZaiConfig, K as applyXiaomiConfig, L as applyQianfanProviderConfig, Lt as validateAnthropicSetupToken, M as applyMoonshotProviderConfig, Mt as ZAI_CN_BASE_URL, N as applyMoonshotProviderConfigCn, Nt as ZAI_CODING_CN_BASE_URL, O as applyKimiCodeConfig, Ot as KIMI_CODING_MODEL_REF, P as applyOpenrouterConfig, Pt as ZAI_CODING_GLOBAL_BASE_URL, Q as applyCloudflareAiGatewayConfig, R as applySyntheticConfig, S as applyMinimaxApiProviderConfigCn, St as setVeniceApiKey, T as applyAuthProfileConfig, Tt as setXiaomiApiKey, U as applyVeniceProviderConfig, V as applyTogetherProviderConfig, W as applyXaiConfig, X as applyLitellmConfig, Y as applyZaiProviderConfig, Z as applyLitellmProviderConfig, _ as applyOpencodeZenConfig, _t as setOpencodeZenApiKey, at as TOGETHER_DEFAULT_MODEL_REF, b as applyMinimaxApiConfigCn, bt as setSyntheticApiKey, ct as ZAI_DEFAULT_MODEL_REF, d as mergeConfigPatch, dt as setGeminiApiKey, et as applyVercelAiGatewayConfig, f as pickAuthMethod, ft as setHuggingfaceApiKey, g as resolvePluginProviders, gt as setMoonshotApiKey, h as isRemoteEnvironment, ht as setMinimaxApiKey, it as OPENROUTER_DEFAULT_MODEL_REF, j as applyMoonshotConfigCn, jt as XAI_DEFAULT_MODEL_REF, k as applyKimiCodeProviderConfig, kt as MOONSHOT_DEFAULT_MODEL_REF, lt as setAnthropicApiKey, m as createVpsAwareOAuthHandlers, mt as setLitellmApiKey, nt as HUGGINGFACE_DEFAULT_MODEL_REF, ot as VERCEL_AI_GATEWAY_DEFAULT_MODEL_REF, p as resolveProviderMatch, pt as setKimiCodingApiKey, q as applyXiaomiProviderConfig, rt as LITELLM_DEFAULT_MODEL_REF, st as XIAOMI_DEFAULT_MODEL_REF, t as githubCopilotLoginCommand, tt as applyVercelAiGatewayProviderConfig, u as applyDefaultModel, ut as setCloudflareAiGatewayConfig, v as applyOpencodeZenProviderConfig, vt as setOpenrouterApiKey, w as applyMinimaxProviderConfig, wt as setXaiApiKey, x as applyMinimaxApiProviderConfig, xt as setTogetherApiKey, y as applyMinimaxApiConfig, yt as setQianfanApiKey, z as applySyntheticProviderConfig } from "./github-copilot-auth-BiaSo_ZY.js";
