...
if (!ensureExperimentalWarningSuppressed()) {
	...
	import("./run-main-CFUQ7yfI.js").then(({ runCli }) => runCli(process$1.argv)).catch((error) => {
...
//#endregion
export { resolveOAuthPath as $, warn as A, DEFAULT_GATEWAY_PORT as B, isVerbose as C, hasHelpOrVersion as Ct, setVerbose as D, resolveEffectiveHomeDir as Dt, logVerboseConsole as E, expandHomePrefix as Et, getLogger as F, resolveConfigPathCandidate as G, isNixMode as H, getResolvedLoggerSettings as I, resolveGatewayPort as J, resolveDefaultConfigCandidates as K, toPinoLikeLogger as L, isRich as M, theme as N, shouldLogVerbose as O, resolveRequiredHomeDir as Ot, getChildLogger as P, resolveOAuthDir as Q, normalizeLogLevel as R, info as S, hasFlag as St, logVerbose as T, normalizeProfileName as Tt, resolveCanonicalConfigPath as U, STATE_DIR as V, resolveConfigPath as W, resolveLegacyStateDirs as X, resolveIsNixMode as Y, resolveNewStateDir as Z, restoreTerminalState as _, getCommandPath as _t, parseBooleanValue as a, formatChannelPrimerLine as at, unregisterActiveProgressLine as b, getPrimaryCommand as bt, enableConsoleCapture as c, listChatChannels as ct, setConsoleTimestampPrefix as d, normalizeChatChannelId as dt, resolveStateDir as et, shouldLogSubsystemToConsole as f, getActivePluginRegistry as ft, defaultRuntime as g, buildParseArgv as gt, createNonExitingRuntime as h, normalizeWindowsArgv as ht, normalizeEnv as i, DEFAULT_CHAT_CHANNEL as it, colorize as j, success as k, routeLogsToStderr as l, normalizeAnyChannelId as lt, visibleWidth as m, setActivePluginRegistry as mt, isTruthyEnvValue as n, CHANNEL_IDS as nt, createSubsystemLogger as o, formatChannelSelectionLine as ot, stripAnsi as p, requireActivePluginRegistry as pt, resolveGatewayLockDir as q, logAcceptedEnvOption as r, CHAT_CHANNEL_ORDER as rt, runtimeForLogger as s, getChatChannelMeta as st, installProcessWarningFilter as t, resolvePreferredOpenClawTmpDir as tt, setConsoleSubsystemFilter as u, normalizeChannelId as ut, clearActiveProgressLine as v, getFlagValue as vt, isYes as w, shouldMigrateStateFromPath as wt, danger as x, getVerboseFlag as xt, registerActiveProgressLine as y, getPositiveIntFlagValue as yt, CONFIG_PATH as z };