...
import { T as logVerbose, n as isTruthyEnvValue, o as createSubsystemLogger, x as danger } from "./entry.js";
import { i as loadConfig } from "./config-Dhccn237.js";
import { c as resolveTelegramAccount } from "./plugins-BnuyZ2Wy.js";
import { a as markdownToIR, i as chunkMarkdownIR, n as loadWebMedia, v as resolveMarkdownTableMode } from "./media-jAjl2iil.js";
import { t as renderMarkdownWithMarkers } from "./render-CC3QzhUn.js";
import { n as normalizePollInput } from "./polls-sXdvQw2C.js";
import { S as mediaKindFromMime, c as getFileExtension, d as isGifMedia, p as normalizeMimeType } from "./image-ops-DIfvMtad.js";
import { n as formatErrorMessage, r as formatUncaughtError, t as extractErrorCode } from "./errors-CTMu4lH4.js";
import { n as redactSensitiveText } from "./redact-1PNP01B_.js";
import { i as createTelegramRetryRunner, n as recordChannelActivity } from "./channel-activity-zsOWc2wE.js";
import { n as wrapFetchWithAbortSignal, t as resolveFetch } from "./fetch-BBIf29w7.js";
...
//#endregion
export { hasBotMention as A, parseTelegramTarget as B, buildTelegramGroupPeerId as C, describeReplyTarget as D, buildTypingThreadParams as E, resolveTelegramThreadSpec as F, formatLocationText as I, toLocationContext as L, resolveTelegramForumThreadId as M, resolveTelegramReplyId as N, expandTextLinks as O, resolveTelegramStreamMode as P, withTelegramApiErrorLogging as R, buildTelegramGroupFrom as S, buildTelegramThreadParams as T, resolveTelegramFetch as _, sendMessageTelegram as a, buildSenderLabel as b, send_exports as c, makeProxyFetch as d, isRecoverableTelegramNetworkError as f, wrapFileReferencesInHtml as g, renderTelegramHtmlText as h, reactMessageTelegram as i, normalizeForwardedContext as j, extractTelegramLocation as k, resolveTelegramVoiceSend as l, markdownToTelegramHtml as m, deleteMessageTelegram as n, sendPollTelegram as o, markdownToTelegramChunks as p, editMessageTelegram as r, sendStickerTelegram as s, buildInlineKeyboard as t, wasSentByBot as u, splitTelegramCaption as v, buildTelegramParentPeer as w, buildSenderName as x, buildGroupLabel as y, isVoiceCompatibleAudio as z };