import { M as isRich, N as theme, Y as resolveIsNixMode, et as resolveStateDir, g as defaultRuntime, j as colorize } from "./entry.js";
...
import { n as resolveAgentConfig } from "./agent-scope-D-q7eKVm.js";
import "./github-copilot-token-Cqx9_dJi.js";
import "./manifest-registry-By5_tzJo.js";
import { F as VERSION, i as loadConfig } from "./config-Dhccn237.js";
...
import { s as resolveBrowserConfig } from "./server-context-s3xWq7m3.js";
...
import { n as createBrowserRouteDispatcher, r as getMachineDisplayName, t as withTimeout } from "./with-timeout-CXT6WujF.js";
import { Rt as loadOrCreateDeviceIdentity, t as GatewayClient } from "./client-Csp-2oRh.js";
import { t as formatDocsLink } from "./links-CsVmLlFn.js";
import { _ as analyzeArgvCommand, c as recordAllowlistUse, f as resolveExecApprovalsSocketPath, g as resolveSafeBins, h as evaluateShellAllowlist, l as requiresExecApproval, m as evaluateExecAllowlist, n as addAllowlistEntry, o as normalizeExecApprovals, p as saveExecApprovals, r as ensureExecApprovals, s as readExecApprovalsSnapshot, u as resolveExecApprovals } from "./exec-approvals-DxO73AVL.js";
import { c as formatNodeServiceDescription, g as resolveNodeWindowsTaskName, h as resolveNodeSystemdServiceName, m as resolveNodeLaunchAgentLabel } from "./constants-C8AL7skZ.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-ofysbnRa.js";
import { d as renderSystemNodeWarning, f as resolvePreferredNodePath, h as resolveNodeProgramArguments, o as resolveGatewayDevMode, p as resolveSystemNodeInfo, r as isGatewayDaemonRuntime, s as buildNodeServiceEnvironment, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-DjNAwwST.js";
import { s as resolveGatewayLogPaths } from "./service-7hnvi87Y.js";
import "./systemd-BP_hPj6J.js";
import { h as emitDaemonActionJson, i as runServiceUninstall, m as createNullWriter, p as buildDaemonServiceSnapshot, r as runServiceStop, s as parsePort, t as runServiceRestart } from "./lifecycle-core-DpDzkcah.js";
import { r as formatRuntimeStatus } from "./systemd-hints-B4GOKYS1.js";
import { t as resolveNodeService } from "./node-service-RvjhtsGc.js";
import { n as validateSystemRunCommandConsistency } from "./system-run-command-BzuoXsbJ.js";
