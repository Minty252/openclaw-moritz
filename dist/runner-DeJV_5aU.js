import { Y as logVerbose, Z as shouldLogVerbose, n as runExec } from "./exec-DWBzVcJJ.js";
import { H as resolveOpenClawAgentDir, S as resolveApiKeyForProvider, f as normalizeGoogleModelId, o as normalizeProviderId, x as requireApiKey } from "./model-selection-BvTZ4qvn.js";
import { C as detectMime, D as isAudioFileName, J as normalizeChatType, T as getFileExtension, k as kindFromMime } from "./image-ops-uJWMortG.js";
import { n as loadConfig } from "./config-D9FGRQVc.js";
import { t as describeImageWithModel, x as ensureOpenClawModelsJson } from "./image-4emtT7uP.js";
import { a as fetchWithTimeout, n as fetchRemoteMedia, r as fetchWithSsrFGuard, t as MediaFetchError } from "./fetch-Blco4SB7.js";
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-vDqtLL0B.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenClawAgentDir());
