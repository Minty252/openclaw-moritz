...
import { $ as resolveOAuthPath, B as DEFAULT_GATEWAY_PORT, G as resolveConfigPathCandidate, H as isNixMode, J as resolveGatewayPort, K as resolveDefaultConfigCandidates, Ot as resolveRequiredHomeDir, Q as resolveOAuthDir, U as resolveCanonicalConfigPath, V as STATE_DIR, W as resolveConfigPath, X as resolveLegacyStateDirs, Y as resolveIsNixMode, Z as resolveNewStateDir, dt as normalizeChatChannelId, et as resolveStateDir, nt as CHANNEL_IDS, q as resolveGatewayLockDir, z as CONFIG_PATH } from "./entry.js";
import { Ct as shouldEnableShellEnvFallback, M as parseModelRef, Mt as DEFAULT_CONTEXT_TOKENS, St as shouldDeferShellEnvFallback, bt as loadShellEnvFallback, xt as resolveShellEnvFallbackTimeoutMs } from "./auth-profiles-BWqNRMgG.js";
import { l as normalizeAgentId, n as DEFAULT_AGENT_ID } from "./session-key-DVvxnFKg.js";
import { d as isRecord, g as resolveConfigDir, u as isPlainObject$2, y as resolveUserPath } from "./utils-DZM-aXiE.js";
import { c as resolveDefaultAgentId, s as resolveAgentWorkspaceDir } from "./agent-scope-D-q7eKVm.js";
import { c as resolveEnableState, l as resolveMemorySlotDecision, s as normalizePluginsConfig, t as loadPluginManifestRegistry } from "./manifest-registry-By5_tzJo.js";
