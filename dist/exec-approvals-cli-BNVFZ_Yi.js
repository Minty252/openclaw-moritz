...
import { p as saveExecApprovals, s as readExecApprovalsSnapshot } from "./exec-approvals-Ds_-fx37.js";
import { n as callGatewayFromCli } from "./gateway-rpc-eiHJcrRm.js";
import "./service-BmdpdrKO.js";
import "./systemd-CfWFfqz_.js";
import { t as renderTable } from "./table-BLMSXjAe.js";
import { t as describeUnknownError } from "./shared-3Z_vz38U.js";
import { n as nodesCallOpts, r as resolveNodeId } from "./rpc-DVteZd5U.js";
...
function registerExecApprovalsCli(program) {
	...
	nodesCallOpts(allowlist.command("add <pattern>").description("Add a glob pattern to an allowlist").option("--node <node>", "Target node id/name/IP").option("--gateway", "Force gateway approvals", false).option("--agent <id>", "Agent id (defaults to \"*\")").action(async (pattern, opts) => {
		try {
			...
			if (!trimmed) exitWithError("Pattern required.");
