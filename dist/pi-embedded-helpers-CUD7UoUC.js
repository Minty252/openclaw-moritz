...
import { C as normalizeAccountId$1, E as resolveAgentIdFromSessionKey, T as normalizeMainKey, _ as DEFAULT_AGENT_ID, a as DEFAULT_IDENTITY_FILENAME, c as DEFAULT_USER_FILENAME, h as resolveOpenClawPackageRootSync, i as DEFAULT_HEARTBEAT_FILENAME, l as ensureAgentWorkspace, n as DEFAULT_AGENT_WORKSPACE_DIR, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_BOOTSTRAP_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME, w as normalizeAgentId, y as buildAgentMainSessionKey } from "./workspace-CAwOqECe.js";
import { A as escapeRegExp, B as resolveUserPath, C as requireActivePluginRegistry, I as normalizeE164, T as CONFIG_DIR, d as defaultRuntime, g as CHAT_CHANNEL_ORDER, h as CHANNEL_IDS, l as createSubsystemLogger, n as runExec, q as truncateUtf16Safe, st as resolvePreferredOpenClawTmpDir, v as getChatChannelMeta } from "./exec-kNgoQ-Yt.js";
import { l as resolveSessionAgentId, n as resolveAgentConfig } from "./agent-scope-mFm05wNX.js";
import { G as resolveSlackAccount, H as resolveTelegramAccount, K as resolveSlackReplyToMode, L as normalizeChannelId, Y as normalizeChatType, Z as resolveDiscordAccount, _ as listDeliverableMessageChannels, a as resizeToJpeg, n as getImageMetadata, v as normalizeMessageChannel, z as normalizeWhatsAppTarget } from "./image-ops-Db3kwMRr.js";
import { t as parseBooleanValue } from "./boolean-Bb19hm9Y.js";
import { t as formatCliCommand } from "./command-format-BmTFj7S4.js";
import { A as resolveWhatsAppAccount, _ as resolveEnableState, a as writeConfigFile, d as parseDurationMs, g as normalizePluginsConfig, n as loadConfig, p as loadPluginManifestRegistry, s as parseByteSize, t as createConfigIO, v as resolveMemorySlotDecision } from "./config-Dr8z937s.js";
import { n as resolveSignalAccount } from "./accounts-CtwwdhBe.js";
import { A as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, C as DEFAULT_AI_SNAPSHOT_EFFICIENT_DEPTH, D as DEFAULT_BROWSER_EVALUATE_ENABLED, E as DEFAULT_BROWSER_DEFAULT_PROFILE_NAME, O as DEFAULT_OPENCLAW_BROWSER_COLOR, T as DEFAULT_AI_SNAPSHOT_MAX_CHARS, _ as ensureChromeExtensionRelayServer, a as resolveOpenClawUserDataDir, b as isLoopbackHost, c as captureScreenshot, d as normalizeCdpWsUrl, f as snapshotAria, h as getHeadersWithAuth, i as launchOpenClawChrome, k as DEFAULT_OPENCLAW_BROWSER_ENABLED, l as createTargetViaCdp, n as isChromeCdpReady, o as stopOpenClawChrome, p as appendCdpPath, r as isChromeReachable, s as resolveBrowserExecutableForPlatform, v as stopChromeExtensionRelayServer, w as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS } from "./chrome-BaJk80VF.js";
import { a as parseFrontmatterBlock, c as resolveRuntimePlatform, i as resolveOpenClawManifestBlock, n as normalizeStringList, o as hasBinary, r as parseFrontmatterBool, s as isConfigPathTruthyWithDefaults, t as getFrontmatterString } from "./frontmatter-yyc9d0b4.js";
import { n as formatErrorMessage, t as extractErrorCode } from "./errors-Daa2hz8x.js";
import { r as saveMediaBuffer, t as ensureMediaDir } from "./store-Bx3kRvoj.js";
import { t as resolveIMessageAccount } from "./accounts-DUDaWZJW.js";
import { n as resolveSessionFilePath, s as resolveStorePath, t as resolveDefaultSessionStorePath } from "./paths-Ck4L046D.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-JGGQViao.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-BomM11M6.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-CtguEtYT.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-CtguEtYT.js")).closePlaywrightBrowserConnection();
		} catch {}
...
//#endregion
export { updateSessionStoreEntry as $, normalizeToolName as $t, isCompactionFailureError as A, resolveBrowserConfig as At, parseImageSizeError as B, assertMediaNotDataUrl as Bt, formatAssistantErrorText as C, resolveChannelGroupPolicy as Ct, isAuthAssistantError as D, resolveGroupSessionKey as Dt, getApiErrorPayloadFingerprint as E, resolveConversationLabel as Et, isRateLimitAssistantError as F, buildWorkspaceSkillCommandSpecs as Ft, extractDeliveryInfo as G, ensureBrowserControlAuth as Gt, ensureSandboxWorkspaceForSession as H, resolveSandboxedMediaSource as Ht, isRawApiErrorPayload as I, buildWorkspaceSkillSnapshot as It, loadSessionStore as J, applyOwnerOnlyToolPolicy as Jt, appendAssistantMessageToSessionTranscript as K, resolveBrowserControlAuth as Kt, isTimeoutErrorMessage as L, loadWorkspaceSkillEntries as Lt, isFailoverAssistantError as M, DEFAULT_UPLOAD_DIR as Mt, isFailoverErrorMessage as N, resolvePathsWithinRoot as Nt, isBillingAssistantError as O, createBrowserRouteContext as Ot, isLikelyContextOverflowError as P, getBridgeAuthForPort as Pt, updateSessionStore as Q, expandToolGroups as Qt, isTransientHttpError as R, resolveSkillsPromptForRun as Rt, classifyFailoverReason as S, listChannelDocks as St, formatRawAssistantErrorForUi as T, resolveChannelGroupToolsPolicy as Tt, resolveSandboxContext as U, applySkillEnvOverrides as Ut, sanitizeUserFacingText as V, assertSandboxPath as Vt, resolveSandboxRuntimeStatus as W, applySkillEnvOverridesFromSnapshot as Wt, recordSessionMetaFromInbound as X, collectExplicitAllowlist as Xt, readSessionUpdatedAt as Y, buildPluginToolGroups as Yt, updateLastRoute as Z, expandPolicyWithPluginGroups as Zt, sanitizeSessionMessagesImages as _, canonicalizeMainSessionAlias as _t, formatXHighModelHint as a, ensureSessionHeader$1 as an, normalizeDeliveryContext as at, isGoogleModelApi as b, deriveSessionMetaPatch as bt, normalizeReasoningLevel as c, sanitizeGoogleTurnOrdering as cn, acquireSessionWriteLock as ct, normalizeVerboseLevel as d, resolveChannelResetConfig as dt, resolveToolProfilePolicy as en, isCacheEnabled as et, resolveResponseUsageMode as f, resolveSessionResetPolicy as ft, normalizeTextForComparison as g, resolveFreshSessionTotalTokens as gt, isMessagingToolDuplicateNormalized as h, DEFAULT_RESET_TRIGGERS as ht, formatThinkingLevels as i, buildBootstrapContextFiles as in, mergeDeliveryContext as it, isContextOverflowError as j, resolveProfile as jt, isCloudCodeAssistFormatError as k, registerBrowserRoutes as kt, normalizeThinkLevel as l, resolveSessionKey as lt, isMessagingToolDuplicate as m, resolveThreadFlag as mt, validateGeminiTurns as n, compileGlobPatterns as nn, deliveryContextFromSession as nt, listThinkingLevels as o, resolveBootstrapMaxChars as on, normalizeSessionDeliveryFields as ot, supportsXHighThinking as p, resolveSessionResetType as pt, resolveMirroredTranscriptText as q, resolveSandboxConfigForAgent as qt, pickFallbackThinkingLevel as r, matchesAnyGlobPattern as rn, deliveryContextKey as rt, normalizeElevatedLevel as s, resolveBootstrapTotalMaxChars as sn, normalizeAccountId as st, validateAnthropicTurns as t, stripPluginOnlyAllowlist as tn, resolveCacheTtlMs as tt, normalizeUsageDisplay as u, evaluateSessionFreshness as ut, downgradeOpenAIReasoningBlocks as v, resolveExplicitAgentSessionKey as vt, formatBillingErrorMessage as w, resolveChannelGroupRequireMention as wt, BILLING_ERROR_USER_MESSAGE as x, getChannelDock as xt, isAntigravityClaude as y, resolveMainSessionKey as yt, parseImageDimensionError as z, resolvePluginSkillDirs as zt };