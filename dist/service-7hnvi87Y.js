import { M as isRich, N as theme, j as colorize } from "./entry.js";
import { f as resolveGatewayWindowsTaskName, l as resolveGatewayLaunchAgentLabel, p as resolveLegacyGatewayLaunchAgentLabels, s as formatGatewayServiceDescription, t as GATEWAY_LAUNCH_AGENT_LABEL } from "./constants-C8AL7skZ.js";
...
async function execLaunchctl(args) {
	try {
		const { stdout, stderr } = await execFileAsync$1("launchctl", args, { encoding: "utf8" });
		return {
