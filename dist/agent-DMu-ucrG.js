import { d as defaultRuntime, v as DEFAULT_CHAT_CHANNEL } from "./subsystem-BbhgPUzd.js";
import { G as normalizeVerboseLevel, L as formatThinkingLevels, R as formatXHighModelHint, U as normalizeThinkLevel, q as supportsXHighThinking } from "./pi-embedded-helpers-DLeTj87G.js";
import { $r as resolveAgentTimeoutMs, Ar as lookupContextTokens, B as resolveOutboundTarget, G as runWithModelFallback, In as AGENT_LANE_NESTED, It as getRemoteSkillEligibility, Ln as clearAgentRunContext, Mr as applyModelOverrideToSessionEntry, Nr as applyVerboseOverride, Rn as emitAgentEvent, V as resolveSessionDeliveryTarget, Vn as registerAgentRunContext, d as runEmbeddedPiAgent, i as runCliAgent, jr as clearSessionAuthProfileOverride, l as resolveSendPolicy, n as getCliSessionId, r as setCliSessionId, rn as getSkillsSnapshotVersion } from "./reply-CYMZTXlH.js";
import { d as resolveAgentIdFromSessionKey, l as normalizeAgentId, u as normalizeMainKey } from "./session-key-BWxPj0z_.js";
import { a as resolveAgentModelPrimary, i as resolveAgentModelFallbacksOverride, o as resolveAgentSkillsFilter, r as resolveAgentDir, s as resolveAgentWorkspaceDir, t as listAgentIds, x as ensureAgentWorkspace } from "./agent-scope-dwzDG1b1.js";
import { Ct as ensureAuthProfileStore, Ft as DEFAULT_CONTEXT_TOKENS, It as DEFAULT_MODEL, Lt as DEFAULT_PROVIDER, a as isCliProvider, d as resolveConfiguredModelRef, h as resolveThinkingDefault, o as modelKey, t as buildAllowedModelSet } from "./model-selection-ChgnVmWu.js";
import { t as formatCliCommand } from "./command-format-ChfKqObn.js";
import { i as loadConfig } from "./config-DTbrEHqs.js";
import { r as normalizeChannelId, t as getChannelPlugin } from "./plugins-o2q9tVRq.js";
import { C as resolveChannelResetConfig, S as evaluateSessionFreshness, T as resolveSessionResetType, i as loadSessionStore, j as resolveExplicitAgentSessionKey, l as updateSessionStore, v as normalizeAccountId, w as resolveSessionResetPolicy, x as resolveSessionKey } from "./sessions-BsVHT42i.js";
import { s as loadModelCatalog } from "./runner-STmMAoZV.js";
import { r as buildWorkspaceSkillSnapshot } from "./skills-C1b_I-in.js";
import { a as isInternalMessageChannel, d as resolveMessageChannel, i as isGatewayMessageChannel, l as normalizeMessageChannel, n as isDeliverableMessageChannel, t as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-djjBp_ms.js";
import { c as resolveStorePath, n as resolveSessionFilePath } from "./paths-DyUlTxmU.js";
import { a as normalizeOutboundPayloadsForJson, i as normalizeOutboundPayloads, r as formatOutboundPayloadLog, t as deliverOutboundPayloads } from "./deliver-N3OqJwZc.js";
import { l as deriveSessionTotalTokens, u as hasNonzeroUsage } from "./session-cost-usage-r-Rovr3R.js";
import { t as createDefaultDeps } from "./deps-DGzocYMK.js";
import { t as createOutboundSendDeps } from "./outbound-send-deps-CPPXXRp_.js";
