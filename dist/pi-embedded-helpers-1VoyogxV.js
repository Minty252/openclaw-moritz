import { E as truncateUtf16Safe } from "./utils-DZM-aXiE.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-BQAYNcA_.js";
import { s as formatSandboxToolPolicyBlockedMessage } from "./sandbox-CWeyov8H.js";
...
//#endregion
export { parseImageSizeError as A, listThinkingLevels as B, isFailoverErrorMessage as C, isTimeoutErrorMessage as D, isRawApiErrorPayload as E, resolveBootstrapTotalMaxChars as F, normalizeVerboseLevel as G, normalizeReasoningLevel as H, sanitizeGoogleTurnOrdering as I, resolveResponseUsageMode as K, formatThinkingLevels as L, buildBootstrapContextFiles as M, ensureSessionHeader as N, isTransientHttpError as O, resolveBootstrapMaxChars as P, formatXHighModelHint as R, isFailoverAssistantError as S, isRateLimitAssistantError as T, normalizeThinkLevel as U, normalizeElevatedLevel as V, normalizeUsageDisplay as W, isAuthAssistantError as _, isMessagingToolDuplicateNormalized as a, isCompactionFailureError as b, downgradeOpenAIReasoningBlocks as c, BILLING_ERROR_USER_MESSAGE as d, classifyFailoverReason as f, getApiErrorPayloadFingerprint as g, formatRawAssistantErrorForUi as h, isMessagingToolDuplicate as i, sanitizeUserFacingText as j, parseImageDimensionError as k, isAntigravityClaude as l, formatBillingErrorMessage as m, validateGeminiTurns as n, normalizeTextForComparison as o, formatAssistantErrorText as p, supportsXHighThinking as q, pickFallbackThinkingLevel as r, sanitizeSessionMessagesImages as s, validateAnthropicTurns as t, isGoogleModelApi as u, isBillingAssistantError as v, isLikelyContextOverflowError as w, isContextOverflowError as x, isCloudCodeAssistFormatError as y, listThinkingLevelLabels as z };