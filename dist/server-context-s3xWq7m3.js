...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-89R2G8If.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-89R2G8If.js")).closePlaywrightBrowserConnection();
		} catch {}
...
//#endregion
export { resolveBrowserControlAuth as a, resolveProfile as c, getUsedColors as d, getUsedPorts as f, ensureBrowserControlAuth as i, allocateCdpPort as l, deriveDefaultBrowserCdpPortRange as m, listKnownProfileNames as n, parseHttpUrl as o, isValidProfileName as p, getPwAiModule as r, resolveBrowserConfig as s, createBrowserRouteContext as t, allocateColor as u };