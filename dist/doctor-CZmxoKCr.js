import { I as getResolvedLoggerSettings, J as resolveGatewayPort, Ot as resolveRequiredHomeDir, Q as resolveOAuthDir, Y as resolveIsNixMode, et as resolveStateDir, g as defaultRuntime, n as isTruthyEnvValue, z as CONFIG_PATH } from "./entry.js";
import { F as resolveConfiguredModelRef, It as CLAUDE_CLI_PROFILE_ID, L as resolveHooksGmailModel, Lt as CODEX_CLI_PROFILE_ID, Nt as DEFAULT_MODEL, O as getModelRefStatus, Pt as DEFAULT_PROVIDER, b as updateAuthProfileStoreWithLock, f as repairOAuthProfileIdMismatch, ft as resolveApiKeyForProvider, o as resolveProfileUnusableUntilForDisplay, s as resolveApiKeyForProfile, v as ensureAuthProfileStore } from "./auth-profiles-BWqNRMgG.js";
import { t as formatCliCommand } from "./command-format-BA3gs9CO.js";
import { C as sleep, S as shortenHomePath, y as resolveUserPath } from "./utils-DZM-aXiE.js";
import { n as runExec, t as runCommandWithTimeout } from "./exec-aioTkwpP.js";
import { t as resolveOpenClawPackageRoot } from "./openclaw-root-BKsZvO6K.js";
import { c as resolveDefaultAgentId, d as DEFAULT_AGENTS_FILENAME, r as resolveAgentDir, s as resolveAgentWorkspaceDir } from "./agent-scope-D-q7eKVm.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-qI8rBmks.js";
import { l as writeConfigFile, o as readConfigFileSnapshot } from "./config-Dhccn237.js";
import { n as listChannelPlugins } from "./plugins-BnuyZ2Wy.js";
import { Ct as loadOpenClawPlugins } from "./reply-CrwRmeCr.js";
import { l as resolveGatewayBindHost, r as isLoopbackHost } from "./ws-BmKx9hzC.js";
import { i as resolveGatewayAuth } from "./auth-CjzSe-Vc.js";
import { i as formatPortDiagnostics, n as inspectPortUsage } from "./ports-B01ecUzU.js";
import { i as loadSessionStore, j as resolveMainSessionKey } from "./sessions-BK1H0ugi.js";
import { s as loadModelCatalog } from "./runner-DoVotVW7.js";
import { C as DEFAULT_SANDBOX_BROWSER_IMAGE, T as DEFAULT_SANDBOX_IMAGE, d as resolveSandboxScope, w as DEFAULT_SANDBOX_COMMON_IMAGE } from "./sandbox-CWeyov8H.js";
import { c as resolveStorePath, n as resolveSessionFilePath, s as resolveSessionTranscriptsDirForAgent } from "./paths-DiTZA01b.js";
import { n as resolveMemorySearchConfig } from "./manager-BkjmfXHe.js";
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-B9XcIpQ-.js";
import { i as readChannelAllowFromStore } from "./pairing-store-6LVzE5wS.js";
import { f as printWizardHeader, m as randomToken, n as applyWizardMetadata, s as guardCancel } from "./onboard-helpers-l1NHeo7i.js";
import { n as isWSLEnv, t as isWSL } from "./wsl-DBqKtTtI.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-B6Z4pIdl.js";
import { d as resolveGatewaySystemdServiceName, f as resolveGatewayWindowsTaskName, l as resolveGatewayLaunchAgentLabel, m as resolveNodeLaunchAgentLabel } from "./constants-C8AL7skZ.js";
import { t as note$1 } from "./note-BmK3mDX7.js";
import { t as resolveChannelDefaultAccountId } from "./helpers-DEDpe-6P.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-Dl2yGMxQ.js";
import { a as gatewayInstallErrorHint, d as renderSystemNodeWarning, i as buildGatewayInstallPlan, n as GATEWAY_DAEMON_RUNTIME_OPTIONS, p as resolveSystemNodeInfo, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-DjNAwwST.js";
import { a as launchAgentPlistExists, i as isLaunchAgentLoaded, o as repairLaunchAgentBootstrap, r as isLaunchAgentListed, s as resolveGatewayLogPaths, t as resolveGatewayService } from "./service-7hnvi87Y.js";
import { r as isSystemdUserServiceAvailable } from "./systemd-BP_hPj6J.js";
import { n as renderSystemdUnavailableHints, r as formatRuntimeStatus, t as isSystemdUnavailableDetail } from "./systemd-hints-B4GOKYS1.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-B895Za_F.js";
import { a as renderGatewayServiceCleanupHints, i as findExtraGatewayServices, n as auditGatewayServiceConfig, r as needsNodeRuntimeMigration, t as SERVICE_AUDIT_CODES } from "./service-audit-unW23j56.js";
import { r as healthCommand } from "./health-MCmtGT7n.js";
import { i as resolveControlUiDistIndexPathForRoot, r as resolveControlUiDistIndexHealth, t as formatHealthCheckFailure } from "./health-format-BemPCTHE.js";
import { n as logConfigUpdated } from "./logging-CL5j2Kfg.js";
import { n as doctorShellCompletion } from "./doctor-completion-D371BUQA.js";
import { t as runGatewayUpdate } from "./update-runner-CLqfQ_Rq.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-BoGfOePC.js";
import { n as detectLegacyStateMigrations, r as runLegacyStateMigrations, t as loadAndMaybeMigrateDoctorConfig } from "./doctor-config-flow-DopzIZw8.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-CfNmUMbG.js";
