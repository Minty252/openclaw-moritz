...
import { E as resolveAgentIdFromSessionKey, T as normalizeMainKey, l as ensureAgentWorkspace, w as normalizeAgentId } from "../../workspace-CAwOqECe.js";
import { _ as DEFAULT_CHAT_CHANNEL, d as defaultRuntime, l as createSubsystemLogger } from "../../exec-kNgoQ-Yt.js";
import { a as resolveAgentModelPrimary, i as resolveAgentModelFallbacksOverride, o as resolveAgentSkillsFilter, r as resolveAgentDir, s as resolveAgentWorkspaceDir, t as listAgentIds } from "../../agent-scope-mFm05wNX.js";
import { T as SILENT_REPLY_TOKEN, a as normalizeOutboundPayloadsForJson, i as normalizeOutboundPayloads, r as formatOutboundPayloadLog, t as deliverOutboundPayloads } from "../../deliver-Bthh_5Hw.js";
...
import { F as getChannelPlugin, L as normalizeChannelId, b as resolveMessageChannel, f as INTERNAL_MESSAGE_CHANNEL, h as isInternalMessageChannel, m as isGatewayMessageChannel, p as isDeliverableMessageChannel, v as normalizeMessageChannel } from "../../image-ops-Db3kwMRr.js";
import "../../boolean-Bb19hm9Y.js";
import { C as modelKey, E as resolveConfiguredModelRef, L as DEFAULT_CONTEXT_TOKENS, R as DEFAULT_MODEL, S as isCliProvider, h as ensureAuthProfileStore, k as resolveThinkingDefault, y as buildAllowedModelSet, z as DEFAULT_PROVIDER } from "../../model-auth-Bos4xjOH.js";
...
import { n as resolveSessionFilePath, s as resolveStorePath } from "../../paths-Ck4L046D.js";
...
import { s as loadModelCatalog } from "../../runner-CfRx2Ecl.js";
...
function createDefaultDeps() {
	return {
		sendMessageWhatsApp: async (...args) => {
			const { sendMessageWhatsApp } = await import("../../web-C1Kt-07i.js");
			return await sendMessageWhatsApp(...args);
		},
		sendMessageTelegram: async (...args) => {
			const { sendMessageTelegram } = await import("../../send-BA6n3AqM.js").then((n) => n.c);
			return await sendMessageTelegram(...args);
		},
		sendMessageDiscord: async (...args) => {
			const { sendMessageDiscord } = await import("../../send-DqFR2tga.js").then((n) => n.t);
			return await sendMessageDiscord(...args);
		},
		sendMessageSlack: async (...args) => {
			const { sendMessageSlack } = await import("../../send-B9hfQuuv.js").then((n) => n.n);
			return await sendMessageSlack(...args);
		},
		sendMessageSignal: async (...args) => {
			const { sendMessageSignal } = await import("../../send-CURnSuQc.js").then((n) => n.i);
			return await sendMessageSignal(...args);
		},
		sendMessageIMessage: async (...args) => {
			const { sendMessageIMessage } = await import("../../send-h0_uAQzq.js").then((n) => n.n);
