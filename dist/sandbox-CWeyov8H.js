import { V as STATE_DIR, g as defaultRuntime, nt as CHANNEL_IDS } from "./entry.js";
...
import { y as resolveUserPath } from "./utils-DZM-aXiE.js";
import { b as DEFAULT_USER_FILENAME, d as DEFAULT_AGENTS_FILENAME, f as DEFAULT_AGENT_WORKSPACE_DIR, h as DEFAULT_IDENTITY_FILENAME, l as resolveSessionAgentId, m as DEFAULT_HEARTBEAT_FILENAME, n as resolveAgentConfig, p as DEFAULT_BOOTSTRAP_FILENAME, v as DEFAULT_SOUL_FILENAME, x as ensureAgentWorkspace, y as DEFAULT_TOOLS_FILENAME } from "./agent-scope-D-q7eKVm.js";
import { d as resolveSandboxInputPath, f as resolveSandboxPath, o as syncSkillsToWorkspace } from "./skills-_fFRgbPu.js";
import { i as loadConfig } from "./config-Dhccn237.js";
import { a as resolveBrowserControlAuth, c as resolveProfile, i as ensureBrowserControlAuth, t as createBrowserRouteContext } from "./server-context-s3xWq7m3.js";
import { r as isLoopbackHost } from "./ws-BmKx9hzC.js";
import { C as DEFAULT_BROWSER_EVALUATE_ENABLED, E as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, w as DEFAULT_OPENCLAW_BROWSER_COLOR } from "./chrome-BRBns8fW.js";
import { c as safeEqualSecret } from "./auth-CjzSe-Vc.js";
import { O as canonicalizeMainSessionAlias, k as resolveAgentMainSessionKey } from "./sessions-BK1H0ugi.js";
import { t as registerBrowserRoutes } from "./routes-CaSRevJn.js";
...
//#endregion
export { DEFAULT_SANDBOX_BROWSER_IMAGE as C, matchesAnyGlobPattern as S, DEFAULT_SANDBOX_IMAGE as T, expandToolGroups as _, ensureSandboxWorkspaceForSession as a, stripPluginOnlyAllowlist as b, resolveSandboxRuntimeStatus as c, resolveSandboxScope as d, resolveSandboxToolPolicyForAgent as f, expandPolicyWithPluginGroups as g, collectExplicitAllowlist as h, removeSandboxContainer as i, getBridgeAuthForPort as l, buildPluginToolGroups as m, listSandboxContainers as n, resolveSandboxContext as o, applyOwnerOnlyToolPolicy as p, removeSandboxBrowserContainer as r, formatSandboxToolPolicyBlockedMessage as s, listSandboxBrowsers as t, resolveSandboxConfigForAgent as u, normalizeToolName as v, DEFAULT_SANDBOX_COMMON_IMAGE as w, compileGlobPatterns as x, resolveToolProfilePolicy as y };