...
import { D as setVerbose, M as isRich, N as theme, et as resolveStateDir, g as defaultRuntime, j as colorize, o as createSubsystemLogger } from "./entry.js";
import { S as shortenHomePath, x as shortenHomeInString, y as resolveUserPath } from "./utils-DZM-aXiE.js";
...
import { t as splitShellArgs } from "./shell-argv-wdKphi9C.js";
import { d as listMemoryFiles, f as normalizeExtraMemoryPaths } from "./sqlite-DV-Oz6PD.js";
import { t as formatDocsLink } from "./links-CsVmLlFn.js";
import { r as withManager } from "./cli-utils-C4wXq5N-.js";
import { n as withProgress, r as withProgressTotals } from "./progress-CPwotF7H.js";
...
async function getMemorySearchManager(params) {
	...
	if (resolved.backend === "qmd" && resolved.qmd) {
		...
		try {
			const { QmdMemoryManager } = await import("./qmd-manager-Nc1s12K9.js");
			...
			if (primary) {
				...
				const wrapper = new FallbackMemoryManager({
					...
					fallbackFactory: async () => {
						const { MemoryIndexManager } = await import("./manager-BkjmfXHe.js").then((n) => n.t);
