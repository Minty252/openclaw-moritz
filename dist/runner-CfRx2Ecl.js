import { Q as shouldLogVerbose, X as logVerbose, n as runExec } from "./exec-kNgoQ-Yt.js";
import { A as kindFromMime, E as getFileExtension, O as isAudioFileName, Y as normalizeChatType, w as detectMime } from "./image-ops-Db3kwMRr.js";
import { A as normalizeGoogleModelId, _ as resolveOpenClawAgentDir, i as resolveApiKeyForProvider, r as requireApiKey, w as normalizeProviderId } from "./model-auth-Bos4xjOH.js";
import { n as loadConfig } from "./config-Dr8z937s.js";
import { t as describeImageWithModel, x as ensureOpenClawModelsJson } from "./image-Drpoo6S0.js";
import { a as fetchWithTimeout, n as fetchRemoteMedia, r as fetchWithSsrFGuard, t as MediaFetchError } from "./fetch-DNxVU_z5.js";
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-CnNPWPgM.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenClawAgentDir());
